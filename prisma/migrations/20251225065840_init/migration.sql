...
-- CreateEnum
CREATE TYPE "DenominationStatus" AS ENUM ('fixed', 'amount');
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_subCategoryId_fkey" FOREIGN KEY ("subCategoryId") REFERENCES "OccasionCategory"("id") ON DELETE SET NULL ON UPDATE CASCADE;
